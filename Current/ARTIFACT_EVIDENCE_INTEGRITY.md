...
Repository API verification confirmed the snapshot has both `FILE_INDEX.json` and `export.r2x`, while the runtime root contains `INDEX.json`, `analysis/`, and `raw/`.

## Latest built artifact: S1.42AC
...
- Runtime index: `RuntimeEvidence/S1.42AC/20260904T181854Z/INDEX.json`
- Raw runtime log SHA-256: `fe4b4a20996d0b76d9f1bdd8551a233138a032c1321c417a56e1ac3948ae8067`
- Original decision: `Current/106_S1.42AC_RUNTIME_REJECTION_BCMER_EVENTTYPE_EQUAL_DISTRIBUTION.md`
- Corrected source analysis: `Current/109_BCMER_1_71_0_EVENTTYPE_WEIGHT_PATH_ANALYSIS.md`

The runtime root also has `INDEX.json`, `analysis/`, and `raw/`.
